...
class Admin extends Admin_Controller {
	...
	public function edit()
	{
		...
		if($this->input->is_ajax_request())
		{
			...
			if($this->input->post('update') == 'main_account_info')
			{
				...
				{
					$response = 1;
					$response_txt = 'The <strong>main account info</strong> has been updated.';
				}
			}
			
			if($this->input->post('update') == 'phone_numbers')
			{
				$data = array(
				...
				{
					$response = 1;
					$response_txt = 'The <strong>phone number(s)</strong> have been updated.';
				}
			}
