				...
				<div class="panel-body">
					...
					<form id="formContent" class="form-material"  data-toggle="validator">
						...
						<ul class="nav nav-tabs" role="tablist">
							...
							<li role="presentation" class="active"><a href="#section1" aria-controls="section1" role="tab" data-toggle="tab" aria-expanded="true">Section 1</a></li>
							<li role="presentation"><a href="#section2" aria-controls="section2" role="tab" data-toggle="tab" aria-expanded="true">Section 2</a></li>
							<li role="presentation"><a href="#section3" aria-controls="section3" role="tab" data-toggle="tab" aria-expanded="true">Section 3</a></li>
							<li role="presentation"><a href="#section4" aria-controls="section4" role="tab" data-toggle="tab" aria-expanded="true">Section 4</a></li>
							<li role="presentation"><a href="#section5" aria-controls="section5" role="tab" data-toggle="tab" aria-expanded="true">Section 5</a></li>
						</ul>
						...
						<div class="tab-content">
							...
							<div role="tabpanel" class="tab-pane" id="section3">
								<div class="form-group">
									...
									<textarea id="section3" name="section3" class="summernote">
										<?php if(isset($data->section3)) echo $data->section3; ?>
									</textarea>
								</div>
								<div class="clearfix"></div>
							</div>
							...
							<div role="tabpanel" class="tab-pane active" id="section4">
								<div class="form-group">
									...
									<textarea id="section4" name="section1" class="summernote">
										<?php if(isset($data->section4)) echo $data->section4; ?>
									</textarea>
								</div>
								<div class="clearfix"></div>
							</div>
							...
							<div role="tabpanel" class="tab-pane active" id="section5">
								<div class="form-group">
									...
									<textarea id="section5" name="section1" class="summernote">
										<?php if(isset($data->section5)) echo $data->section5; ?>
									</textarea>
								</div>
								<div class="clearfix"></div>
							</div>
