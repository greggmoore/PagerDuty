...
<head>
	...
	<link rel="icon" type="image/x-icon" href="https://www.blumoocreative.com/system/cms/modules/themes/blumoo/assets/images/favicons/blumoo.ico" />
	<?php 
		...
		<nav class="navbar navbar-default navbar-static-top m-b-0">
			<div class="navbar-header">
				<div class="top-left-part">
					...
					<li><a href="javascript:void(0)" class="logotext"><!--This is logo text--><img style="max-height: 50px;" src="/data/logos/moohead100.png" alt="home" class="light-logo" /></a></li>
				</ul>
