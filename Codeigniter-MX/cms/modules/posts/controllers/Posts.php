...
class Posts extends Public_Controller {
	...
	public function index()
	{
		...
		$data = array(
			...
			'canonical' => '<link rel="canonical" href="https://www.blumoocreative.com/blog" />'
		);
	...
	public function post()
	{
	    ...
	    $this->og_image = base_url().'data/uploads/blumoo-creative-logo-screenshot.jpg' ;
		...
		$this->page_url = base_url().$uri ;
			...
			$this->open_graph = array(
		        array('property' => 'og:url', 'content' => 'https://www.blumoocreative.com/blog/'.$uri ) ,
		        array('property' => 'og:title', 'content' => $title ) ,
		        array('property' => 'og:description', 'content' => $meta_description ? $meta_description : $this->meta_description ) ,
	    ...
	    $data = array(
			...
			'js' => js(array('posts.js'), $this->module->uri) ,
			'article' => $article ,
			'canonical' => '<link rel="canonical" href="https://www.blumoocreative.com/blog/'.$uri.'" />'
		);
	...
	public function article()
	{
		...
		{
			$this->og_image = base_url().'data/uploads/'.$article->og_image ;
		}
		
		$this->page_url = base_url().'blog/'.$uri ;
		
			$this->open_graph = array(
		        array('property' => 'og:url', 'content' => 'https://www.blumoocreative.com/blog/'.$uri ) ,
		        array('property' => 'og:title', 'content' => $article->title ) ,
		        array('property' => 'og:description', 'content' => $meta_description ? $meta_description : $this->meta_description ) ,
		        array('property' => 'og:image', 'content' => $this->og_image ) 
		    );
	...
	public function author()
	{
		...
		$seo = new phpSEO(strip_tags(ucfirst($author->user->bio)));
		...
		$data = array(
			...
			'content' => NULL,
			'css' => css(array('posts.css', 'author.css'), $this->module->uri),
			'intro' => $author->intro,
			'posts' => $author->posts ,
			'canonical' => '<link rel="canonical" href="https://www.blumoocreative.com/posts/author/'.$uri.'" />'
		);
